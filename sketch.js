...
function createBoundaries(){
  topB = createSprite(width/2, 0, width, 10);
  bottomB = createSprite(width/2, height, width, 10);
  leftB = createSprite(0, height/2, 10, height);
  rightB = createSprite(width, height/2, 10, height);
}
...
function spawnZombie(){
  ...
  zombie.scale = 0.07;
  randomSides = Math.round(random(1,4));
  switch(randomSides){
  case 1: zombie.velocityX = -4;
          zombie.velocityY = 0;
  ...
  case 3: zombie.velocityY = -4
          zombie.velocityX = 0;
          zombie.x = Math.round(random(100, 500));
          zombie.y = height +10;
          zombie.lifetime = height/4;
          break;

  case 4: zombie.velocityY = 4
          zombie.velocityX = 0;
          zombie.x = Math.round(random(100, 500));
          zombie.y = -10;
          zombie.lifetime = height/4;
...
zombie.bounceOff(topB);
zombie.bounceOff(bottomB);
zombie.bounceOff(rightB);
zombie.bounceOff(leftB);
